...
CREATE TABLE `interaction`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 65 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '互动行为信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `interaction` VALUES (63, 8, 22, 2, '2026-02-03 17:39:25');
INSERT INTO `interaction` VALUES (64, 8, 23, 2, '2026-02-03 17:40:22');
...
INSERT INTO `operation_log` VALUES (94, 8, '商品发货', '2026-02-03 17:23:53');
INSERT INTO `operation_log` VALUES (95, 2, '确定收货', '2026-02-03 17:26:12');
...
CREATE TABLE `orders`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '订单信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `orders` VALUES (25, '1770109818564', '测试', 2, 7, 259.80, 2, 2, '2026-02-03 17:23:39', 4, '2026-02-03 17:26:05', 1, '2026-02-03 17:26:12', 1, 1, 1, '2026-02-03 17:23:54', 5, '2026-02-03 17:10:19');
INSERT INTO `orders` VALUES (26, '1770111573191', '43242343', 8, 22, 222.00, 1, 3, NULL, 1, NULL, NULL, NULL, NULL, 5, NULL, NULL, NULL, '2026-02-03 17:39:33');
INSERT INTO `orders` VALUES (27, '1770112440686', '', 8, 22, 222.00, 1, 2, '2026-02-03 17:56:33', 1, NULL, NULL, NULL, 0, 5, NULL, NULL, NULL, '2026-02-03 17:54:01');
...
INSERT INTO `product` VALUES (7, '洗衣机', '<p>零食</p>', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=4b0513a11.png,http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=b3554a24.png,http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=4d108755.png', 9, 7, 8, 15, 129.90, 1, '2024-12-14 17:54:43');
...
INSERT INTO `product` VALUES (22, '智能手表1', '<p>手表</p>', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=fda4fb5Snipaste_2025-04-20_13-22-25.png,http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=8ab6e7cSnipaste_2025-04-20_16-30-21.png,http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=b04aaf9Snipaste_2025-04-20_16-30-02.png,http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=b6d203eSnipaste_2025-04-20_13-21-25.png,http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=7815726Snipaste_2025-04-20_13-25-58.png,http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=edfb7c0Snipaste_2025-04-20_16-30-13.png', 9, 5, 2, 0, 222.00, 1, '2025-06-25 21:11:33');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', 'B站【程序员辰星】原创出品', '14e1b600b1fd579f47433b88e8d85291', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=49bf8cepic_6.jpg', '1343243@qq.com', 1, 0, 0, '2026-02-03 17:53:40', '2024-12-04 12:53:05');
INSERT INTO `user` VALUES (2, 'zhangfan', 'B站【程序员辰星】原创出品', '14e1b600b1fd579f47433b88e8d85291', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=0e61962pic_8.jpg', '12311323@qq.com', 2, 0, 0, '2026-02-03 17:27:41', '2024-08-16 16:12:12');
INSERT INTO `user` VALUES (7, 'liran', '李冉1', '14e1b600b1fd579f47433b88e8d85291', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=dadfc6f5.png', '12434@qq.com', 1, 0, 0, '2025-11-11 15:55:05', '2024-10-19 06:39:12');
INSERT INTO `user` VALUES (8, 'lichen', '李琛', '14e1b600b1fd579f47433b88e8d85291', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=45aebe6pic_7.jpg', '12345@qq.com', 2, 0, 0, '2026-02-03 17:03:21', '2024-12-05 15:44:45');
...
INSERT INTO `user` VALUES (11, 'chenxin', '陈芯', '14e1b600b1fd579f47433b88e8d85291', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=a93033f8.png', '123432@qq.com', 2, 0, 0, NULL, '2024-12-05 15:47:08');
...
INSERT INTO `user` VALUES (13, 'fanggui', '方贵', '14e1b600b1fd579f47433b88e8d85291', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=6e7e0f24.png', '43423@qq.com', 2, 0, 0, NULL, '2024-12-05 15:51:13');
INSERT INTO `user` VALUES (14, 'jiangxin', '江心', '14e1b600b1fd579f47433b88e8d85291', 'http://localhost:21090/api/campus-product-sys/v1.0/file/getFile?fileName=f9db5042.png', '124343@qq.com', 2, 0, 0, NULL, '2024-12-05 15:54:50');
